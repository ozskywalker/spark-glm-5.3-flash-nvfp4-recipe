...
# its authors. Gated off by default here too; do not promote without our own
# real-checkpoint coherence/accuracy check, not just a throughput number. See
# recipes/VALIDATION.md, "MiaAI-Lab update analysis: adaptive-k (skip, not
# portable to MTP-2) and FP8 dense projections (real candidate, provisional)".
# ----------------------------------------------------------------------------
